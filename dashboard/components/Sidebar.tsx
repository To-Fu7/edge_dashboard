...
import { LayoutDashboard, Camera, Settings, ScrollText, Activity, Tv2, UserSquare2, HammerIcon, FlaskConical } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/inference', label: 'Build & Inference', icon: HammerIcon },
  { href: '/model-test', label: 'Model Test', icon: FlaskConical },
